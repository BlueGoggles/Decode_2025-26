...
@Config
@Autonomous(name = "Front Red - Just Leave", group = "FrontRed_DecodeAutonomous")
public class FrontRed_JustLeave extends LinearOpMode {
    ...
    public synchronized void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                new SequentialAction(
                        trajectoryActions.getTrajectory_1_1(drive, 0, 0, 0, 5, 0, 0, true)
                )
        );
    }
}
