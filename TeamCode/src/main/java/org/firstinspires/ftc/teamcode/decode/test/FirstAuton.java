...
import org.firstinspires.ftc.teamcode.decode.mechanisms.TestServo;
...
public class FirstAuton  extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("LeftMootrShooter Position", shooter.getLeftWheel().getCurrentPosition());
        telemetry.update();
